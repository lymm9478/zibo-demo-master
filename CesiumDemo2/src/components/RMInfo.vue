<template>
  <div style="transform: translate(5%,5%);
    ...
    <span id="overlay-text">月度预警统计</span>
    <div id="main3" style="height: 100%;width: 100%;left:5%"></div>
  </div>
